...
```
git clone https://github.com/MihaiHng/foundry-smart-contract-lottery-f24.git
...
You'll want to set your `SEPOLIA_RPC_URL` and `PRIVATE_KEY` as environment variables. You can add them to a `.env` file, which won't be included in this repo for security reasons.
